...
class User(Base):
    ...
    username: Mapped[str] = mapped_column(String(50), nullable=False, unique=True, required=False)
    email: Mapped[str] = mapped_column(String(120), nullable=False, unique=True, required=False)
    password: Mapped[str] = mapped_column(String(500), nullable=False, required=True)
