...
class BaseballClient:
    ...
    def __init__(self):
        ...
        self.base_url = current_app.config['BASEBALL_URL']
    ...
    def _make_request(self, endpoint, params=None):
        ...
        try:
            ...
            raise Exception(f"Baseball API error: {str(e)}")
    ...
    def get_live_games(self):
        # get live baseball games happening now
        return self._make_request('games', params={'live': 'all'})
    
    def get_games_by_date(self, date):
        # get baseball games for a specific date (YYYY-MM-DD)
